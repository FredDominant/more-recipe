...
const recipeValidator = (recipe) => {
  ...
  if (Validator.isLength(recipe.name, 5, 20)) {
  ...
  if (Validator.isLength(recipe.description, 5, 20)) {
  ...
  if (Validator.isLength(recipe.directions, 5, 20)) {
  ...
  if (Validator.isLength(recipe.ingredients, 5, 20)) {
