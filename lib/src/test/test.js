...
describe('Test for API', function () {
	describe('GET /', function () {
		...
		it('Should return 404 for posts to undefined routes', function () {
	...
	describe('POST recipe', function () {
		it('Should return no error for a valid request', function () {
		...
		it('Should return 400 for post without recipe name', function () {
			_chai2.default.request(_app2.default).post('/api/v1/recipes').send({
				id: 6,
				ownerId: 12,
				ingredients: ["something"],
		...
		it('Should return 400 for post without recipe description', function () {
			_chai2.default.request(_app2.default).post('/api/v1/recipes').send({
				id: 6,
				ownerId: 12,
				ingredients: ["something"],
	...
	describe('API to Get all recipes', function () {
		...
		it('Should return 200 for sorted recipes', function () {
	...
	describe('API to update recipe', function () {
		it('Should return 200 if successful', function () {
	...
	describe('Test for review', function () {
		it('Should return 201 if successful', function () {
		...
		it('Should return 400 if empty parameters', function () {
			_chai2.default.request(_app2.default).post('/api/v1/recipes/1/review').send({
				content: "Just a test content",
				recipe: 3
			}).end(function (err, res) {
	...
	describe('API delete recipe', function () {
		it('Should return 200 for succesful delete request ', function () {
			_chai2.default.request(_app2.default).delete('/api/v1/recipes/:2').end(function (err, res) {
				expect(err).to.be.null;
				expect(res).to.have.status(200);
				done();
			});
		});
		it('Should return 404 if parameter is not found', function () {
